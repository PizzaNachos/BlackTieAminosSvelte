...
<div class="container">
  {#if renderable_data.valid}
    <article>
      ...
      <p>
        What happens now? We've received your order and are already working on
        it! If you have any questions or comments don't hesitate to email us at
            ...
            <div class="border_wrapper">
              <div class="cart_item">
                <img
                  ...
                  src={get_prod_from_stripe_key(pro.stripe_id)
